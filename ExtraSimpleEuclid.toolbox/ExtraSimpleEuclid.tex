...
\@x{}\moduleLeftDash\@xx{ {\MODULE} ExtraSimpleEuclid}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
...
\@x{ {\p@mmfair} {\p@algorithm} Euclid}%
 \@x{\@s{8.2} {\p@lbrace}\@s{4.1} {\p@variables} x \.{=} M ,\, y \.{=} N
 {\p@semicolon}}%
\@x{\@s{16.4} {\p@lbrace} {\p@while} {\p@lparen} x \.{\neq} y {\p@rparen}}%
\@x{\@s{25.98}}%
\@y{\@s{0}%
...
\@xx{}%
 ...
 {\p@lbrace} y \.{:=} y\@s{0.10} \.{-} x {\p@semicolon} {\p@rbrace}}%
 \@x{\@s{35.56} {\p@else}\@s{24.59} {\p@lbrace} x\@s{9.09} \.{:=} x \.{-}
 y\@s{0.10} {\p@semicolon} {\p@rbrace}}%
\@x{\@s{25.98} {\p@rbrace}}%
...
\@x{}%
\@y{\@s{0}%
 \ensuremath{PC} means \ensuremath{PartialCorrectness ,\,} but it\mbox{'}s a
 lot easier to write and read.
}%
\@xx{}%
 \@x{ PC \.{\defeq} ( pc \.{=}\@w{Done} ) \.{\implies} ( x \.{=} y ) \.{\land}
 ( x \.{=} GCD ( M ,\, N ) )}%
\@pvspace{8.0pt}%
\@x{ Inv \.{\defeq} {\TRUE}}%
\@pvspace{8.0pt}%
\@x{ I1 \.{\defeq} Init \.{\implies} Inv}%
\@x{ I2 \.{\defeq} Inv \.{\land} Next \.{\implies} Inv \.{'}}%
\@x{ I3 \.{\defeq} Inv \.{\implies} PC}%
\@pvspace{16.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 10:28:04 \ensuremath{PST} 2014 by \ensuremath{bbeckman
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Created Sun \ensuremath{Feb} 16 10:15:18
 \ensuremath{PST} 2014 by \ensuremath{bbeckman
}%
\end{cpar}%
\end{lcom}%
\end{document}
