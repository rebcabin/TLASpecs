...
\@x{\@s{16.4} {\p@variable} b \.{\in} \{ 0 ,\, 1 \} {\p@semicolon}}%
\@x{\@s{16.4} {\p@lbrace}\@s{8.2} {\p@while} {\p@lparen} {\TRUE} {\p@rparen}}%
 \@x{\@s{34.18} {\p@lbrace}\@s{8.2} {\p@if} {\p@lparen} b \.{=} 0 {\p@rparen}
 b \.{:=} 1 {\p@else} b \.{:=} 0 {\p@semicolon}}%
\@x{\@s{34.18} {\p@rbrace}}%
\@x{\@s{16.4} {\p@rbrace}}%
\@x{ {\p@rbrace}}%
\@y{}%
...
\@xx{}%
\@x{\@s{39.83} \.{\land} b\@s{1.04} \.{\in} \{ 0 ,\, 1 \}}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} {\IF} b \.{=} 0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 08:54:51 \ensuremath{PST} 2014 by \ensuremath{bbeckman
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sun \ensuremath{Feb} 16 08:53:40
