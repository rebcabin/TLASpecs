...
\@pvspace{8.0pt}%
\@x{ Init1\@s{4.12} \.{\defeq} ( b\@s{7.42} \.{=} 0 ) \.{\lor} ( b \.{=} 1 )}%
\@pvspace{8.0pt}%
\@x{ Next3 \.{\defeq} b \.{'}\@s{8.50} \.{=} ( b \.{+} 1 ) \.{\%} 2}%
\@pvspace{8.0pt}%
 \@x{ Next2 \.{\defeq} b \.{'}\@s{8.50} \.{=} {\IF} b \.{=} 0 \.{\THEN} 1
 \.{\ELSE} 0}%
\@pvspace{8.0pt}%
 \@x{ Next4 \.{\defeq} \.{\land} ( b \.{=} 0 ) \.{\implies} ( b \.{'} \.{=} 1
 )}%
\@x{\@s{44.83} \.{\land} ( b \.{=} 1 ) \.{\implies} ( b \.{'} \.{=} 0 )}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 08:51:04 \ensuremath{PST} 2014 by \ensuremath{bbeckman
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Fri} \ensuremath{Feb} 14
 06:47:02 \ensuremath{PST} 2014 by \ensuremath{bbeckman
}%
\end{cpar}%
\end{lcom}%
\end{document}
