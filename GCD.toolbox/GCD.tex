...
\end{cpar}%
\end{mcom}%
\@x{\@s{24.59} \E\, q \.{\in} Int \.{:}\@s{41.99}}%
\@x{\@s{49.60} n \.{=} q \.{*} p\@s{24.71}}%
\multivspace{3}%
\@pvspace{8.0pt}%
 \@x{ DivisorsOf ( n ) \.{\defeq} \{ p \.{\in} Int \.{:} Divides ( p ,\, n )
 \}}%
\@pvspace{8.0pt}%
\@x{ SetMax ( S ) \.{\defeq}\@s{123.0}}%
\@y{\@s{0}%
 \ensuremath{{\CHOOSE}} produces elements rather than sets.
}%
\@xx{}%
...
\@pvspace{8.0pt}%
\@x{ GCD ( m ,\, n ) \.{\defeq}}%
\@x{\@s{27.27} SetMax ( DivisorsOf ( m ) \.{\cap} DivisorsOf ( n ) )}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 09:44:33 \ensuremath{PST} 2014 by \ensuremath{bbeckman
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Created \ensuremath{Fri}
 \ensuremath{Feb} 14 11:26:38 \ensuremath{PST} 2014 by \ensuremath{bbeckman
}%
\end{cpar}%
\end{lcom}%
\end{document}
