...
\@pvspace{8.0pt}%
 \@x{ TypeOK \.{\defeq} big \.{\in} 0 \.{\dotdot} 5 \.{\land} small \.{\in} 0
 \.{\dotdot} 3}%
\@pvspace{8.0pt}%
...
\@pvspace{8.0pt}%
\@x{ FillBig\@s{9.97} \.{\defeq} \.{\land} small \.{'} \.{=} small}%
\@x{\@s{59.67} \.{\land} big \.{'}\@s{10.88} \.{=} 5}%
\@pvspace{8.0pt}%
 \@x{ EmptySmall \.{\defeq} small \.{'} \.{=} 0 \.{\land} big \.{'}\@s{10.88}
 \.{=} big}%
 \@x{ EmptyBig\@s{9.97} \.{\defeq} big \.{'}\@s{10.88} \.{=} 0 \.{\land} small
 \.{'} \.{=} small}%
\@pvspace{8.0pt}%
...
\@pvspace{8.0pt}%
 ...
 \.{+} small ,\, 5 ) \.{-} big}%
 \@x{\@s{70.66} \.{\IN} \.{\land} big \.{'}\@s{10.88} \.{=} big\@s{18.93}
 \.{+} poured}%
\@x{\@s{91.06} \.{\land} small \.{'} \.{=} small\@s{8.05} \.{-} poured}%
\@pvspace{8.0pt}%
 \@x{ BigToSmall \.{\defeq} \.{\LET} poured \.{\defeq} Min ( big \.{+} small
 ,\, 3 ) \.{-} small}%
 \@x{\@s{70.66} \.{\IN} \.{\land} big \.{'}\@s{10.88} \.{=} big\@s{18.93}
 \.{-} poured}%
\@x{\@s{91.06} \.{\land} small \.{'} \.{=} small\@s{8.05} \.{+} poured}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 09:34:25 \ensuremath{PST} 2014 by \ensuremath{bbeckman
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Fri} \ensuremath{Feb} 14
 08:11:11 \ensuremath{PST} 2014 by \ensuremath{bbeckman
}%
\end{cpar}%
\end{lcom}%
\end{document}
