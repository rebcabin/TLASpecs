...
\@x{ {\p@mmalgorithm} DieHarder}%
 \@x{\@s{8.2} {\p@lbrace} {\p@variables} x ,\, injug \.{=} [ j \.{\in} Jugs
...
\@x{ {\VARIABLES} x ,\, injug}%
\@pvspace{8.0pt}%
\@x{ vars\@s{2.10} \.{\defeq} {\langle} x ,\, injug {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Init\@s{4.12} \.{\defeq}}%
\@y{\@s{0}%
 Global variables
...
\@xx{}%
\@x{\@s{39.83} \.{\land} x \.{=} defaultInitValue}%
\@x{\@s{39.83} \.{\land} injug \.{=} [ j \.{\in} Jugs \.{\mapsto} 0 ]}%
\@pvspace{8.0pt}%
 \@x{ Next \.{\defeq} \.{\land} \.{\lor} \.{\land} \E\, j\@s{9.27} \.{\in}
 Jugs \.{:}}%
 \@x{\@s{81.36} injug \.{'} \.{=} [ injug {\EXCEPT} {\bang} [ j ] \.{=}
 Capacity [ j ] ]}%
\@x{\@s{50.94} \.{\lor} \.{\land} \E\, j \.{\in} Jugs \.{:}}%
\@x{\@s{81.36} injug \.{'} \.{=} [ injug {\EXCEPT} {\bang} [ j ] \.{=} 0 ]}%
\@x{\@s{50.94} \.{\lor} \.{\land} \E\, j \.{\in} Jugs \.{:}}%
\@x{\@s{81.36} \E\, k \.{\in} Jugs \.{\,\backslash\,} \{ j \} \.{:}}%
 \@x{\@s{89.56} \.{\LET} poured \.{\defeq} Min ( injug [ j ] \.{+} injug [ k ]
 ,\, Capacity [ k ] )}%
\@x{\@s{157.86} \.{-} injug [ k ] \.{\IN}}%
 \@x{\@s{97.76} injug \.{'} \.{=} [ injug {\EXCEPT} {\bang} [ j ]\@s{1.16}
 \.{=} injug [ j ]\@s{1.16} \.{-} poured ,\,}%
\@x{\@s{203.91} {\bang} [ k ] \.{=} injug [ k ] \.{+} poured ]}%
\@x{\@s{39.83} \.{\land} x \.{'} \.{=} x}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Feb} 17 08:13:37 \ensuremath{PST} 2014 by \ensuremath{bbeckman
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
